...
const TWITTER_HANDLE = '0xandyh';
const TWITTER_LINK = `https://twitter.com/${TWITTER_HANDLE}`;
const OPENSEA_LINK = '';
const TOTAL_MINT_COUNT = 50;

const CONTRACT_ADDRESS = "0xFd89c6B51951d7373A83F895f132EDaEf268222C";
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <p className="header gradient-text">Andy's NFT Collection</p>
          ...
          <p className="opensea-container">
             <a href="https://testnets.opensea.io/collection/mobowork-nft" className="btn btn-primary">Check on OpenSea</a>
          </p>
        </div>
